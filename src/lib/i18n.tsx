...
const en = {
  ...
  home: {
    ...
    ebWhy: "Who you're hiring",
    ebServices: "What we do",
    ebProjects: "Our work",
    ebProcess: "How it works",
    ebReviews: "Client feedback",
    ebFaq: "Good to know",
    ebAreas: "Where we work",
    statCrew: "person crew, owner on every job",
...
const es: UiCopy = {
  ...
  home: {
    ...
    ebWhy: "A quién contrata",
    ebServices: "Lo que hacemos",
    ebProjects: "Nuestro trabajo",
    ebProcess: "Cómo funciona",
    ebReviews: "Opiniones de clientes",
    ebFaq: "Bueno saberlo",
    ebAreas: "Dónde trabajamos",
    statCrew: "personas en el equipo, el dueño en cada obra",
    ...
    prevSlide: "Proyecto anterior",
    nextSlide: "Proyecto siguiente",
...
export function LanguageToggle({ className = "" }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`group inline-flex items-center gap-2 border border-border bg-background px-3.5 py-2 font-display text-xs font-bold uppercase tracking-[0.14em] text-foreground transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-copper/60 hover:text-copper ${className}`}
    >
