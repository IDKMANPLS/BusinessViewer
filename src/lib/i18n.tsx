...
const en = {
  ...
  home: {
    ...
    ownerQuote: "I still go out on every job. If my name is on it, I'm standing behind it.",
    ownerSignature: "— Jim Todorovitch Jr., Owner",
...
const es: UiCopy = {
  ...
  home: {
    ...
    ownerQuote: "Todavía salgo a cada obra. Si lleva mi nombre, yo respondo por ella.",
    ownerSignature: "— Jim Todorovitch Jr., Dueño",
