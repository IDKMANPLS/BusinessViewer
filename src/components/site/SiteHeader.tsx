  ...
  return (
    <>
      ...
      <header
        ...
        className={`sticky top-0 z-40 border-b bg-background transition-[border-color,box-shadow] duration-500 ease-out ${
          scrolled
            ? "border-border shadow-[0_10px_30px_-24px_color-mix(in_oklab,var(--asphalt)_60%,transparent)]"
            : "border-transparent"
        }`}
      >
        <div
